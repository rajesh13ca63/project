     ...
     <div class="jumbotron">
        <form role="form" name="f" method="post" action="">
            ...
            <div class="row">
                ...
                <div class="col-sm-6 form-group">
                     <input type="checkbox" name="clerk[]" id="clerk">AddUser
                     <input type="checkbox" name="clerk[]" id="clerk">EditUser
                     <input type="checkbox" name="clerk[]" id="clerk">DeleteUser
                     <input type="checkbox" name="clerk[]" id="clerk">View
                     <input type="checkbox" name="clerk[]" id="clerk">All
                </div>
            </div>  
            <div>       
